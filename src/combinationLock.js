...
const comboLockState = {
  ...
  function updateComboLockUI() {
    ...
    document.getElementById("digitTop").src =
      `public/char/lock/lock-top-${comboLockState.digits[0]}.png`;
    document.getElementById("digitMid").src =
      `public/char/lock/lock-mid-${comboLockState.digits[1]}.png`;
    document.getElementById("digitBot").src =
      `public/char/lock/lock-bot-${comboLockState.digits[2]}.png`;
